...
public class HomeStatusesFragment extends Fragment implements
	...
	public void initAdapter() {
		...
		StatusDataManager.getInstance().getHomeStatusesByPage(this, this, page);
	}
	...
	public void onRefresh() {
		mHandler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				StatusDataManager.getInstance().getHomeStatusesByPage(HomeStatusesFragment.this, HomeStatusesFragment.this, page);
			}
		}, 1000);
	}
		...
		if(null != statusData){	
			switch(flag){
				case 0: 
					...
					mAdapter = new StatusDataAdapter(HomeStatusesFragment.this, mDataList);
					mListView.setAdapter(mAdapter);
					mListView.setXListViewListener(HomeStatusesFragment.this);
					pbLoading.setVisibility(View.GONE);
					onLoad();
					break;
				case 1:
